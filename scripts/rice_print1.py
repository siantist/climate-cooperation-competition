...
class Rice:
    ...
    def __init__(
        ...
        # pickle out
        import pickle
        #pickle_out = open('action_space_file.pickle', 'wb')
        #pickle.dump(self.action_space, pickle_out)
        #pickle_out.close()

        print("self action space is, ", self.action_space)
        # Set the default action mask (all ones)
        pickle_out = open('selfactionsnvec_file.pickle', 'wb')
        pickle.dump(self.actions_nvec, pickle_out)
        pickle_out.close()
        self.len_actions = sum(self.actions_nvec)
        print("self len actions is, ", self.len_actions)
    ...
    def generate_observation(self):
        ...
        # save to pickle file
        import pickle
        #pickle_out1 = open('action_mask_dict_file.pickle', 'wb')
        #pickle.dump(action_mask_dict, pickle_out1)
        #pickle_out1.close()
        ...
        #print("feat dict len is :", len(features_dict))
        #print("action mask dict len is:", len(action_mask_dict))
        
        #pickle_out = open('obs_dict.pickle', 'wb')
        #pickle.dump(obs_dict, pickle_out)
        #pickle_out.close()
        return obs_dict
    ...
    def evaluation_step(self, actions=None):
        ...
        print("proposal decisions are,", proposal_decisions)
